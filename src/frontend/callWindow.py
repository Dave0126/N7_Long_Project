...
class sim_subWindow(QWidget, sim_subWindow.Ui_Simulation_Window):
    def __init__(self, *args, **kwargs):
        super(sim_subWindow, self).__init__(*args, **kwargs)
...
if __name__ == "__main__":
  ...
  mainWindow = Window()
  subWindow = sim_subWindow()
  mainWindow.actionSim_v1.triggered.connect(subWindow.show)
  mainWindow.show()

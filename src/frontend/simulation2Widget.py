...
class Ui_simulation2Widget(object):
    def setupUi(self, simulation2Widget):
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(simulation2Widget)
        ...
        self.latTextEdit = QtWidgets.QTextEdit(simulation2Widget)
        ...
        self.latTextEdit.setPlaceholderText("")
        self.latTextEdit.setObjectName("latTextEdit")
        self.horizontalLayout_5.addWidget(self.latTextEdit)
        ...
        self.lngTextEdit = QtWidgets.QTextEdit(simulation2Widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lngTextEdit.setPlaceholderText("")
        self.lngTextEdit.setObjectName("lngTextEdit")
        self.horizontalLayout_4.addWidget(self.lngTextEdit)
    ...
    def retranslateUi(self, simulation2Widget):
        ...
        self.label_3.setText(_translate("simulation2Widget", "Auto Simple"))
